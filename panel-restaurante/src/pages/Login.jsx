...
export default function Login() {
  ...
  return (
    <div style={{ padding: '40px 20px', display: 'flex', flexDirection: 'column', alignItems: 'center', minHeight: '100vh', justifyContent: 'center' }}>
      ...
      <div style={{ fontSize: 28, fontWeight: 800, color: 'var(--c-text)', marginBottom: 4 }}>Panel Restaurante</div>
      <p style={{ fontSize: 13, color: 'var(--c-muted)', marginBottom: 32 }}>Gestiona tus pedidos y carta</p>
